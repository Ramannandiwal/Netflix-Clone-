...
<div className='  mx-10 relative'>
            ...
            <div className='flex items-center flex-col justify-center'>
                ...
                <h3 className=' w-2/3 text-2xl text-white font-bold '>Send children on adventures with their favourite characters in a space made just for them—free with your membership.</h3>
            </div>
